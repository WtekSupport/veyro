...
pub fn strip_whisper_hallucinations(text: &str) -> String {
    const MARKERS: &[&str] = &[
        ...
        "Подписывается интересный канал",
        "интересный канал в интернете",
...
fn is_whisper_hallucination_only(text: &str) -> bool {
    ...
    const KNOWN_ONLY: &[&str] = &[
        ...
        "подписываетсяинтересныйканалвинтернете",
        "подписываетсяинтересныйканал",
        "интересныйканалвинтернете",
        "спасибозапросмотр",
        "благодарюзапросмотр",
...
mod tests {
    ...
    #[test]
    fn strips_youtube_channel_subscribe_hallucination() {
        let raw = "Реальный текст. Подписывается интересный канал в интернете.";
        assert_eq!(clean_raw_transcription(raw), "Реальный текст.");
        assert!(clean_raw_transcription("Подписывается интересный канал в интернете.").is_empty());
    }
